...
func ValidateUserError(validation_err error, ) *rest_err.RestErr {
	//jsonErr: erro de tipo — quando o JSON tem um valor com tipo diferente do esperado.
	var jsonErr *json.UnmarshalTypeError
	//jsonValidationError: erro de validação — quando o valor está presente, mas não atende às regras (ex: campo obrigatório, email inválido, etc).
